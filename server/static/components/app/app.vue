<template>
  ...
  <section>
    <div class="mb-4 is-flex is-justify-content-center is-align-items-center">
      <icon icon="assets/easy-share.png"></icon>
      <h1 class="title ml-2">Easy Share</h1>
    </div>
  </section>
  <section>
    <div class="container">
  ...
  <section>
    <div class="mt-4 content has-text-centered">
      ...
      <div class="buttons is-centered are-medium">
        <!-- GitHub Button -->
        <a href="https://github.com/vm75/easy-share" target="_blank" class="button is-dark">
          <span class="icon">
        ...
        <!-- Docker Hub Button -->
        <a href="https://hub.docker.com/repository/docker/vm75/easy-share" target="_blank" class="button is-info">
          <span class="icon">
      ...
      <!-- Attribution Link -->
      <a href="https://www.flaticon.com/free-icons/file-transfer" title="file transfer icons" class="attribution-link">
        File transfer icons created by Freepik - Flaticon
      </a>
    </div>
  </section>
</template>
